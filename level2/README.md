Write a program that will accept commands in the below syntax and print the result in the console. Once a command is executed, the program should wait for the next command.
